...
namespace Sniper
{
    [CalloutProperties("Sniper", "GGGDunlix", "0.1.10")]
...
new Vector3(122.9571f, -892.1083f, 135.782f),
        ...
        public Sniper()
        {
            ...
            InitInfo(location);
            ShortName = "Sniper on Roof";
            CalloutDescription = "Someone is standing on a roof shooting at people with a sniper rifle. Respond Code 3 High.";
            ResponseCode = 2;
            StartDistance = 200f;
        }
